...
CREATE PROCEDURE `sp_store_shorttext`(IN `case_id` BIGINT(20), IN `attribute_id` CHAR(24) CHARSET utf8, IN `new_value` TINYTEXT CHARSET utf8, IN `user_email_hash` CHAR(128) CHARSET utf8)
begin
